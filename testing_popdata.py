...
def get_years_from_names(raw_data: DataFrame, pattern: Pattern) -> List[str]:
    colnames = raw_data.columns
    years = []
    for colname in colnames:
...
geo_ids = [*blah.keys()]
print(blah[geo_ids[10]])
print(blah[geo_ids[20]])
print(blah[geo_ids[30]])
print(blah[geo_ids[40]])
print(blah[geo_ids[50]])
print(blah[geo_ids[100]])
print(blah[geo_ids[500]])
print(blah[geo_ids[1000]])
